...
- Other usage notes:
  - In an unmodded game, a unit must have a locomotor type that supports crushing before it can crush something. Most naval units do not have a locomotor that do, except for the amphibious transports.
